...
| `:core` | Shared models, LLM model manager, download workers, sync workers, plus the base `core.presentation.*` Compose surface (dummy previews, color/spacing tokens, a few components). |
