    ...
    private fun readObject(
        ...
        return when (type) {
            0x0 -> when (info) {
                ...
                0x8 -> false
                0x9 -> true
                else -> error("unsupported 0x0_ marker: 0x${"%02X".format(marker)}")
            }
            0x1 -> {
            ...
            0x2 -> {
                ...
                when (info) {
                    ...
                    else -> error("unsupported real size 0x${"%02X".format(marker)}")
                }
            }
            0x5 -> {
            ...
            else -> error("unsupported bplist marker 0x${"%02X".format(marker)}")
        }
    }
