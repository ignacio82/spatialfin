...
class CastAdapterFactoryTest {
    ...
    @Test
    fun `factory rejects Google Cast receiver until PR 2`() {
        assertThrows(NotImplementedError::class.java) {
            CastAdapterFactory.create(receiver(CastProtocol.GoogleCast))
        }
    }

    @Test
    fun `factory rejects AirPlay receiver until PR 3`() {
        assertThrows(NotImplementedError::class.java) {
