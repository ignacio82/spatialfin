...
fun BaseItemDto.toSpatialFinImages(jellyfinRepository: JellyfinRepository): SpatialFinImages {
...
fun SpatialFinMovieDto.toLocalSpatialFinImages(itemId: UUID): SpatialFinImages {
    return SpatialFinImages(
...
fun SpatialFinShowDto.toLocalSpatialFinImages(itemId: UUID): SpatialFinImages {
    return SpatialFinImages(
        primary = Uri.Builder().appendEncodedPath("images/$itemId/primary").build(),
        backdrop = Uri.Builder().appendEncodedPath("images/$itemId/backdrop").build(),
    )
...
fun SpatialFinSeasonDto.toLocalSpatialFinImages(itemId: UUID): SpatialFinImages {
    return SpatialFinImages(
        primary = Uri.Builder().appendEncodedPath("images/$itemId/primary").build(),
        backdrop = Uri.Builder().appendEncodedPath("images/$itemId/backdrop").build(),
...
fun SpatialFinEpisodeDto.toLocalSpatialFinImages(itemId: UUID): SpatialFinImages {
    return SpatialFinImages(
        primary = Uri.Builder().appendEncodedPath("images/$itemId/primary").build(),
        backdrop = Uri.Builder().appendEncodedPath("images/$itemId/backdrop").build(),
        showPrimary = Uri.Builder().appendEncodedPath("images/$seriesId/primary").build(),
